...
public sealed class GetActiveEquipmentQueryHandlerTests
{
    ...
    public async Task Handle_HeroExists_ReturnsEquippedItemsModifiersAndEmptySlots()
    {
        ...
        var snapshot = new ActiveEquipmentSnapshot(heroId,
        [
        ...
        repository
            .Setup(repository => repository.GetActiveEquipmentByHeroIdAsync(heroId, It.IsAny<CancellationToken>()))
        ...
        // Assert
        result.Should().BeEquivalentTo(new ActiveEquipment(heroId,
        [
            new ActiveEquipmentSlot(helmetSlotId, "HEAD", null),
            new ActiveEquipmentSlot(weaponSlotId, "MAIN_HAND", new EquippedItem(
                equippedInstanceId,
    ...
    public async Task Handle_HeroDoesNotExist_ReturnsNull()
    {
        ...
        var repository = new Mock<IInventoryRepository>();
        repository
            .Setup(repository => repository.GetActiveEquipmentByHeroIdAsync(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
    ...
    private static Equipment CreateEquipment(Guid heroId, Guid slotId, Guid instanceId) => new()
    {
        HeroId = heroId,
        SlotId = slotId,
            ...
            Item = new Item
            {
                ...
                [
                    new ItemModifier
                    {
                        ...
                        {
                            Id = Guid.NewGuid(), Name = "Brutality", Stat = "ATTACK", Value = 12.5m, Type = "FLAT"
                        }
                    }
                ]
            }
