...
public sealed class PlaceholderGrpcClient(RewardPlaceholderService.RewardPlaceholderServiceClient client) : IPlaceholderClient
{
    public async Task<PlaceholderClientResult?> GetByIdAsync(Guid placeholderId, CancellationToken cancellationToken)
    {
        try
        {
